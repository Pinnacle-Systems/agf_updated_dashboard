...
WHEN X.AGE BETWEEN 1 AND 3 THEN '1 - 3'
WHEN X.AGE BETWEEN 3 AND 5 THEN '3 - 5'
WHEN X.AGE BETWEEN 5 AND 10 THEN '5 - 10'
WHEN X.AGE > 10 THEN 'Above 10'  END SLAP, x.idcard,x.DOJ,X.AGE FROM (
SELECT MONTHS_BETWEEN(TRUNC(SYSDATE),A.DOJ)/12 AGE,a.idcard,A.DOJ FROM MISTABLE A 

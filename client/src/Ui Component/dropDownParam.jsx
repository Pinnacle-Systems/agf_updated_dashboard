    ...
    <div className="w-full max-w-md mx-auto p-4">
      ...
      <div className="relative">
        <Dropdown
          ...
          className="w-full bg-white border border-gray-300 rounded-lg shadow-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700 transition-all duration-200 hover:shadow-lg"
          style={{
            fontSize: "14px",
            padding: "12px 16px",
          }}

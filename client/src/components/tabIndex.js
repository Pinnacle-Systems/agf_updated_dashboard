...
const tabs = [
    ...
    { key: "MISDashboard", name: "MISDashboard", component: mainDashboard ,list:true,list_name:"AdminDashboard" },
    { key: "HRDashboard", name: "HRDashboard", component:HRDashboard  ,list:true,list_name:"HRDashboard" },

...
const NewjoinDetails = ({
  ...
  NewData,
  autoFocusBuyer,
  selectedGender1,excelTitle
  // setSelectedGender
}) => {

   console.log(selectedGender1,"clicked value");
...
//   const salaryDet = salaryDetData?.data || [];
  ...
  console.log(NewData,"salaryDet1");
  ...
  useEffect(() => {
   ...
   useEffect(() => {
      setSelectedGender(selectedGender1);
    }, [selectedGender1]);
 ...
 const downloadExcel = async () => {
  ...
  /* =======================
     1️⃣ TITLE ROW
  ======================= */
  worksheet.addRow([excelTitle || "Attrition Joining List Report"]);
  ...
  filteredData.forEach((row) => {
    worksheet.addRow([
      ...
      row.DEPARTMENT,
      row.STATE,
      row.DOJ ? new Date(row.DOJ) : "",
    ]);
  });

  /* =======================
     5️⃣ DATE FORMAT & ALIGNMENT
  ======================= */
  ...
  saveAs(
    ...
    "Attrition Joining List Report.xlsx"
  );
};
  return (
            ...
            <table className="w-full border-collapse border border-gray-300 text-[11px]">
              <thead className="bg-gray-100 text-gray-800 sticky top-0 tracking-wider">
                <tr>
                  ...
                  <th className="border p-2 text-left">IDCard</th>
                  <th className="border p-2 text-left">Name</th>
                  <th className="border p-2 text-left">Gender</th>
                  <th className="border p-2 text-left">Department</th>
                  <th className="border p-2 text-left">State</th>
                  <th className="border p-2 text-left">DOJ</th>
                </tr>
              </thead>
              <tbody>
                {currentRecords.slice(0, 17).map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className="border p-1 text-[10px] w-[25px]"
                        style={{ maxWidth: "25px" }}
                      >
                        {row.GENDER}
                      </td>
                      ...
                      <td
                        className="border p-1 text-[10px] w-[100px] "
                        style={{ maxWidth: "100px" }}
                      >
                        {row.STATE }
                      </td>
                      ...
                      >
                        {row.DOJ
                          ? new Date(row.DOJ).toLocaleDateString("en-IN")
                          : "-"}
                      </td>

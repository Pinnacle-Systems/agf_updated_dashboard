...
const AgewisePFlDetail = ({
 ...
 const downloadExcel = async () => {
    ...
    /* =======================
       1️⃣ TITLE ROW
    ======================= */
    worksheet.addRow(["PF Contribution Age wise Report"]);
    ...
    saveAs(new Blob([buffer]), "PF Contribution Age wise Report.xlsx");
  };
  return (
...
export default AgewisePFlDetail;

...
const NumericCard = ({ misData, selectedBuyer }) => {
  ...
  // Function to calculate percentage based on total and current value
          ...
          >
            <div
              ...
              style={{
                ...
                background: color || 'linear-gradient(to top right, #FFD700, #F4A300)',
              }}
            >
              <img
                src={
            ...
            <div className="text-center mt-5">
              ...
              <div className="flex justify-between items-center">
                ...
                <p className="text-2xl font-bold text-gray-800"  style={{
                  color: color || 'linear-gradient(to top right, #FFD700, #F4A300)',
                }}>
                {activeTabs[i] === "total"
                    ? totalValue1
            ...
            <div className="flex justify-between mt-2">
              <button
                ...
                style={activeTabs[i] === "total" ? { backgroundColor: color || "#CA8A04" } : {}}
              >
                Total
              </button>
              <button
                ...
                className={`w-1/3 px-1 py-1 text-xs font-medium shadow-md transition ${
                  activeTabs[i] === "previousValue" ? "bg-[#CA8A04] text-white" : "bg-gray-200 text-gray-700 hover:bg-[#232E3F] hover:text-white"
                }`}
                style={activeTabs[i] === "previousValue" ? { backgroundColor: color || "#CA8A04" } : {}}
              >
                Male
              </button>
              <button
                ...
                className={`w-1/3 px-1 py-1 rounded-r-full text-xs font-medium shadow-md transition ${
                  activeTabs[i] === "value" ? "bg-[#CA8A04] text-white" : "bg-gray-200 text-gray-700 hover:bg-[#232E3F] hover:text-white"
                }`}
                style={activeTabs[i] === "value" ? { backgroundColor: color || "#CA8A04" } : {}}
              >
                Female
              </button>
            </div>

...
import { useGetFabOutCustQuery, useGetFabricOutwardYearCompareQuery } from "../../../redux/service/fabricOutward";

const FabricOutwardYearCompare = ({
    selectedYear,
    setSelectedYear,
    category,
    finYear,
    ...
    const { data: fabricData } = useGetFabricOutwardYearCompareQuery(
...
export default FabricOutwardYearCompare;

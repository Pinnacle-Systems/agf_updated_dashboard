...
import { useGetFabOutCustQuery, useGetFabricOutwardProcessDetailQuery, useGetFabricOutwardProcessDropdownQuery } from "../../../redux/service/fabricOutward";
...
const CustomerTransProcess = ({
    ...
    const { data: cusTransData, isFetching: isSingleFetching,
        isLoading: isSingleLoading, } = useGetFabricOutwardProcessDetailQuery({
            params: {
    ...
    const { data: custNames } = useGetFabOutCustQuery({
     ...
     const { data: processNames } = useGetFabricOutwardProcessDropdownQuery({
        params: {
            category: category
        },
    });
    ...
    const processData = processNames?.data.map((processName) => ({
        processName,
    }));
                    ...
                    <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="w-48 mr-2">
                            <DropdownNew
                                ...
                                clear={true}
                                otherField="processName"
                                otherValue="processName"
                                placeholder={"Process"}
                                autoFocus={true}
                            />
                        </div>
...
export default CustomerTransProcess;

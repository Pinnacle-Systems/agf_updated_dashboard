...
import { useGetFabOutCustQuery, useGetFabricOutwardQuarterCompareQuery } from "../../../redux/service/fabricOutward";

const FabricOutwardQuarterCompare = ({
    selectedYear,
    setSelectedYear,
    category,
    finYear,
    ...
    const { data: fabricData } = useGetFabricOutwardQuarterCompareQuery(
...
export default FabricOutwardQuarterCompare;

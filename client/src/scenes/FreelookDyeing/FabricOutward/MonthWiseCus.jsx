...
import { useGetFabricOutwardCusByMonthDetailQuery } from "../../../redux/service/fabricOutward";
...
const MonthWiseCus = ({
    ...
    const { data: fabricData } = useGetFabricOutwardCusByMonthDetailQuery(
        {
            params: {
    ...
    return (
        <Card sx={{ borderRadius: 1, boxShadow: 4 }}>
            <CardHeader
                ...
                title={`Outward Breakup - ${selectmonths.split(" ")[0]}`}

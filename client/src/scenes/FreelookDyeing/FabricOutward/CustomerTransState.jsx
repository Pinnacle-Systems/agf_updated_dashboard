...
import { useGetFabOutCustQuery, useGetFabricOutwardStateDetailTransQuery, useGetFabricOutwardStateDropdownQuery } from "../../../redux/service/fabricOutward";
...
const CustomerTransState = ({
    ...
    const { data: cusTransData, isFetching: isSingleFetching,
        isLoading: isSingleLoading, } = useGetFabricOutwardStateDetailTransQuery({
            params: {
    ...
    const { data: stateNames } = useGetFabricOutwardStateDropdownQuery({
        params: {
            category: category
        },
    });
    ...
    const totalOutwardCount = new Set(
    ...
    const downloadExcel = async () => {
        ...
        saveAs(new Blob([buffer]), "Fabric Outward State Wise Details.xlsx");
    };
    return (

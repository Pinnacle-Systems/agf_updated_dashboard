...
const SortedBarChart = ({ topItems }) => {
    ...
    useEffect(() => {
        ...
        categoryAxis.renderer.labels.template.fontSize = 12; // Reduced font size
        ...
        valueAxis.renderer.labels.template.fontSize = 12; // Reduced font size
        ...
        series.tooltip.label.fontSize = 14; // Slightly larger tooltip text
        ...
        labelBullet.label.fontSize = 14; // Larger label font size

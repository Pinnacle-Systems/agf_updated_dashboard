...
import CuttingPrintingGRNTable from "./TableData/CuttingPrintingGRNTable";

const CuttingPrintingGRNCard = ({ companyName, selectedYear }) => {
  ...
  return (
    <Card sx={{ borderRadius: 3, boxShadow: "0 6px 20px rgba(0,0,0,0.06)", height: "100%" }}>
      <CardHeader
        title="Cutting / Printing Store GRN Details"
...
export default CuttingPrintingGRNCard;

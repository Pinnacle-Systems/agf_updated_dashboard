...
import DyedFabricGRNTable from "./TableData/DyedFabricGRNTable";

const DyedFabricGRNCard = ({ companyName, selectedYear }) => {
...
export default DyedFabricGRNCard;

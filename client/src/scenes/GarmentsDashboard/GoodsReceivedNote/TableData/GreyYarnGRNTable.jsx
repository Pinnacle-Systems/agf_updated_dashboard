...
const GreyYarnGRNTable = ({ open, onClose, companyName, selectedYear }) => {
  ...
  const exportToExcel = async () => {
    ...
    const worksheet = workbook.addWorksheet("Grey Yarn GRN");

    worksheet.addRow(["Grey Yarn GRN Register"]);
    ...
    link.href = url;
    link.download = `${companyName}_Grey_Yarn_GRN_${selectedYear}.xlsx`;
    link.click();
  };
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="xl" fullWidth>
      <DialogTitle sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", bgcolor: "#1e3a8a", color: "#fff" }}>
        <Typography variant="h6">Grey Yarn GRN Log ({companyName} — {selectedYear})</Typography>
              ...
              <Table stickyHeader>
                ...
                <TableBody>
                  ...
                  <TableRow sx={{ bgcolor: "#f8fafc", fontWeight: "700" }}>
                    ...
                    <TableCell>{totals.bags.toLocaleString("en-IN")}</TableCell>
...
export default GreyYarnGRNTable;

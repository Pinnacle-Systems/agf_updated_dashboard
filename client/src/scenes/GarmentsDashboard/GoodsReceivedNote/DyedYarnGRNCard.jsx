...
import DyedYarnGRNTable from "./TableData/DyedYarnGRNTable";

const DyedYarnGRNCard = ({ companyName, selectedYear }) => {
...
export default DyedYarnGRNCard;

...
import GreyFabricGRNTable from "./TableData/GreyFabricGRNTable";

const GreyFabricGRNCard = ({ companyName, selectedYear }) => {
...
export default GreyFabricGRNCard;

...
import KnittingStoreGRNTable from "./TableData/KnittingStoreGRNTable";

const KnittingStoreGRNCard = ({ companyName, selectedYear }) => {
  ...
  return (
    <Card sx={{ borderRadius: 3, boxShadow: "0 6px 20px rgba(0,0,0,0.06)", height: "100%" }}>
      <CardHeader
        title="Knitting Store Purchase GRN Register"
...
export default KnittingStoreGRNCard;

...
import { useGetAccessoryProcessDetailsTableQuery, useGetProcessDataTableQuery } from "../../../../redux/AgfServices/ProcessDetails";
...
/* ── Main ── */
const AccessoryProcessDetailsTable = ({
  companyName,
  finYear,
  finYr,
  buyer,
  ...
  console.log("ProcessDetailsTable - API response:", response);
    ...
    () =>
      rawData.filter(
        (r) =>
          ...
          textMatch(r, "ALIASNAME", search.ALIASNAME),
      ),
    [rawData, search],
  );
  ...
  const handleExport = async () => {
    ...
    const ws = wb.addWorksheet("Accessory Details");
    ...
    const columns = [
      ...
      { header: "Alias Name", key: "ALIASNAME", width: 32 },
      { header: "Acc Size", key: "ACCSIZE", width: 16 },
    ...
    /* Row 1 — Title */
    ws.insertRow(1, [`Accessory Process Details`]);
    ...
    saveAs(
      ...
      `AccessoryProcessDetails_${selectedBuyer}_${selectedStatus}_${selectedYear}.xlsx`,
    );
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[9999] flex justify-center items-center">
      <div className="bg-white w-[1360px] h-[630px] p-4 rounded-xl relative">
        ...
        <div className="mt-2">
          <SearchBar
            keys={["ORDERNO", "BUYERCODE", "JOBNO", "ALIASNAME"]}
            labels={{
              ORDERNO: "Order No",
          ...
          <table className="w-[1850px] border-collapse text-[11px] table-fixed">
            <thead className="bg-gray-100 text-gray-800 sticky top-0 tracking-wider">
              <tr>
                ...
                <TH cls="w-20">ALIASNAME</TH>
                <TH cls="w-28">ACCSIZE</TH>
...
export default AccessoryProcessDetailsTable;

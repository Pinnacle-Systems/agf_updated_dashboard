...
import { useGetYarnProcessDetailsTableQuery } from "../../../../redux/AgfServices/ProcessDetails";
...
const YarnProcessDetailsTable = ({
  ...
  const handleExport = async () => {
    ...
    /* Row 1 — Title */
    ws.insertRow(1, [`Yarn Process Details`]);
    ...
    saveAs(
      ...
      `YarnProcessDetails_${selectedBuyer}_${selectedStatus}_${selectedYear}.xlsx`,
    );
  };
...
export default YarnProcessDetailsTable;

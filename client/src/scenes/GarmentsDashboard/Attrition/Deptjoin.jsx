...
import { useGetEsiPf1Query, useGetMisDashboardNewjoinQuery } from "../../../redux/service/misDashboardService";
...
const chartdata = Object.entries(groupdata1).map(([dept, arr]) => ({
  ...
  return (
    <>
      ...
      >
        <CardHeader
          title="Department wise Joining List"
